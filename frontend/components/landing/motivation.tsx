      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col lg:flex-row items-center gap-16 mb-32">
          <div className="flex-1 space-y-4">
            <TextReveal>
              Stop juggling between multiple tools.
            </TextReveal>
          ...
          <div className="flex-1 flex justify-center lg:justify-start">
            <div className="grid grid-cols-2 gap-4">
              <div className="relative">
                ...
                <div className="relative bg-white dark:bg-neutral-900 rounded-xl p-6 shadow-lg border border-neutral-200 dark:border-neutral-800">
        ...
        <div className="text-center space-y-4">
          ...
          <TextReveal className="text-4xl md:text-5xl lg:text-6xl font-bold leading-tight bg-gradient-to-r from-blue-600 via-purple-600 to-cyan-600 bg-clip-text text-transparent">
